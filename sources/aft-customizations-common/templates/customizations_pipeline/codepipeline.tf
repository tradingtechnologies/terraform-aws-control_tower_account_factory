...
resource "aws_codepipeline" "aft_codecommit_customizations_codepipeline" {
  ...
  ##############################################################
  stage {
    name = "Global-Customizations-Plan"
  ...
  ##############################################################
  stage {
    name = "Global-Customizations-Approval"
  ...
  ##############################################################
  # Account-Customizations-Plan
  ##############################################################
  stage {
    name = "Account-Customizations-Plan"
  ...
  ##############################################################
  # Account-Customizations-Plan-Approval-Step
  ##############################################################
  stage {
    name = "Account-Customizations-Plan-Approval"
